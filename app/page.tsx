...
export default function Home() {
  return <main>
    ...
    <footer className="shell"><p className="eyebrow">Have something in mind?</p><a className="footer-link" href="mailto:hello@example.com">Let’s make it happen <span>↗</span></a><div className="footer-bottom"><span>© {new Date().getFullYear()} Johnson Oyebode</span><span>Built with care in Lagos</span></div></footer>
  </main>;
}
