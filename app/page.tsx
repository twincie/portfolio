...
export default function Home() {
  return <main>
    ...
    <section className="hero shell" id="top">
      ...
      <div className="hero-bottom"><div><p>I’m Johnson — a backend engineer specializing in Java, Python, APIs, and production-ready microservices for fintech and beyond.</p><div className="hero-actions"><a className="resume-link" href="/Johnson-Oyebode-CV.pdf" download>Download my CV <span aria-hidden="true">↓</span></a><a className="profile-link" href="https://github.com/twincie" target="_blank" rel="noreferrer">GitHub <span aria-hidden="true">↗</span></a><a className="profile-link" href="https://linkedin.com/in/johnson-oyebode-3a9b4b237" target="_blank" rel="noreferrer">LinkedIn <span aria-hidden="true">↗</span></a></div></div><a className="round-link" href="#work" aria-label="View selected projects">↓</a></div>
    </section>
